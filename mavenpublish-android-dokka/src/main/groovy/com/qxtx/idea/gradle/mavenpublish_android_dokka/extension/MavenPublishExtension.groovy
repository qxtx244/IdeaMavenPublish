package com.qxtx.idea.gradle.mavenpublish_android_dokka.extension

/**
 * @author QXTX-WIN
 * createDate 2024/12/30 20:55
 * Description 插件扩展类
 */
class MavenPublishExtension {
    ...
    /** 附加的文件路径集，可指定多个文件，如 [ xxx/xxx.a, xxx/xxx.txt, xx/xxxx/x/x.mp4, ...]，这些文件将会被打包并发布 */
    ...
    /** 是否发布 htmlDoc，取值为 true 或 false */
    boolean pubHtmlDocEnable = false
    ...
    def pubHtmlDocEnable(boolean b) {
        this.pubHtmlDocEnable = b
    }
